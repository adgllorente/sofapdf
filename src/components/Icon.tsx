...
const PATHS = {
  ...
  highlight: 'M4 20h16M6 16 15 7l2 2-9 9H6zM14 6l2-2 4 4-2 2',
  underline: 'M5 4v8a7 7 0 0 0 14 0V4M4 21h16',
  strikethrough: 'M4 12h16M7 4h7a3 3 0 0 1 2.5 1.3M17 20h-7a3 3 0 0 1-2.5-1.3',
  ...
  shapes: 'M4 10 7 4l3 6zM14 4a3 3 0 1 1 0 6 3 3 0 0 1 0-6zM4 14h7v6H4z',
  alignLeft: 'M4 5h16M4 9h12M4 13h16M4 17h10',
  alignCenter: 'M4 5h16M7 9h10M4 13h16M7 17h10',
  alignRight: 'M4 5h16M8 9h12M4 13h16M10 17h10',
  alignHorizontal: 'M4 4v16M8 8h8M8 12h8M8 16h8',
  alignVertical: 'M4 4h16M8 8v8M12 8v8M16 8v8',
  hand: 'M8 11V5a1.5 1.5 0 0 1 3 0v5-6a1.5 1.5 0 0 1 3 0v6-5a1.5 1.5 0 0 1 3 0v7-3a1.5 1.5 0 0 1 3 0v4c0 5-3 8-7 8h-1c-3 0-5-2-6.5-4L5 14a1.8 1.8 0 0 1 3-2z',
  ...
  undo: 'M9 7 4 12l5 5M4 12h10a6 6 0 0 1 6 6',
  ...
  tag: 'M21 12 13 4H4v9l8 8 9-9zM7 7h.01',
} as const
