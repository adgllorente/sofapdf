...
export const es = {
  ...
  dropzone: {
    ...
    hintTitle: 'Tus archivos no salen de tu dispositivo',
    hint: 'Se abren en memoria. No se envían a ninguna parte.',
    up: 'Subir',
    down: 'Bajar',
    remove: 'Quitar {name}',
  },
  ...
  accessibility: {
    title: 'Comprobación básica de accesibilidad PDF',
    file: 'Archivo',
    size: 'Tamaño',
    result: 'Resultado',
    pass: 'Sí',
    ...
    titleCheck: 'Título del documento',
    titlePresent: 'Hay un título en los metadatos.',
    titleMissing: 'No hay título en los metadatos.',
    language: 'Idioma del documento',
    languagePresent: 'Declarado: {value}.',
    languageMissing: 'No se ha declarado ningún idioma.',
    tagging: 'Documento etiquetado',
    taggingPresent: 'Tiene marcado y estructura etiquetada.',
    taggingMissing: 'No se ha detectado marcado o estructura etiquetada.',
    altText: 'Texto alternativo de figuras',
    altSummary: '{withAlt} de {total} figuras tienen texto alternativo.',
    altMissing: 'Hay figuras sin texto alternativo.',
    noFigures: 'No se han detectado figuras en la estructura.',
    headings: 'Orden y estructura de encabezados',
    headingsSummary: 'Encabezados detectados: {value}.',
    headingsMissing: 'No se han detectado encabezados etiquetados.',
    headingsOrder: 'Se han detectado saltos de nivel: {value}.',
    headingsOk: 'Los niveles de encabezado no presentan saltos.',
    contrast: 'Contraste',
    contrastUnknown: 'No se puede determinar de forma fiable sin interpretar visualmente cada página.',
    unavailable: 'No se puede analizar',
    pageError: 'No se pudo analizar esta página.',
    disclaimer: 'Esta comprobación es orientativa y no sustituye una auditoría completa de accesibilidad. Revisa el PDF con herramientas especializadas y con usuarios de tecnologías de apoyo.',
    footer: 'Generado localmente en el navegador. El documento y este informe no se han enviado a ningún servidor.',
  },
    ...
    accessibility: {
      name: 'Comprobar accesibilidad PDF',
      short: 'Detecta problemas básicos de accesibilidad en la estructura del documento.',
      description: 'Analiza localmente el título, idioma, etiquetado, texto alternativo y encabezados de un PDF y genera un informe comprensible.',
      action: 'Comprobar accesibilidad',
      note: 'Es una comprobación orientativa: no sustituye una auditoría completa de accesibilidad ni una prueba con tecnologías de apoyo.',
    },
    bookmarks: {
